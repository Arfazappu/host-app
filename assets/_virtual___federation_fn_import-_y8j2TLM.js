...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-IF3jPPLj.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-qJoYPOCO.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DakpEQMB.js', import.meta.url).href),import:true}};

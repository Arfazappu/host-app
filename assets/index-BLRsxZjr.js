const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-CBSa7_Qp.js","assets/index-jL0mSeQk.js"])))=>i.map(i=>d[i]);
import { r as requireReact, g as getAugmentedNamespace, a as getDefaultExportFromCjs } from './index-jL0mSeQk.js';
import { r as requireReactDom } from './index-BVuIqp-V.js';
import { i as importShared } from './_virtual___federation_fn_import-_y8j2TLM.js';
...
'loginApp':{url:'https://arfazappu.github.io/login-remote-app/assets/remoteEntry.js',format:'esm',from:'vite'},
  'taskApp':{url:'https://arfazappu.github.io/task-remote-app/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.0':{get:()=>get$1(new URL('__federation_shared_react-IF3jPPLj.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'19.1.0':{get:()=>get$1(new URL('__federation_shared_react-dom-qJoYPOCO.js', import.meta.url).href, remoteFrom), loaded:1}},'react-router-dom':{'7.6.0':{get:()=>get$1(new URL('__federation_shared_react-router-dom-DakpEQMB.js', import.meta.url).href, remoteFrom), loaded:1}}
...
const resolveFetch$3 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __vitePreload(async () => { const {default: fetch} = await Promise.resolve().then(() => browser);return { default: fetch }},true              ?[]:void 0).then(({ default: fetch }) => fetch(...args));
    }
    else {
        _fetch = fetch;
    }
...
class RealtimeClient {
    ...
    connect() {
        ...
        __vitePreload(async () => { const {default: WS} = await import('./browser-CBSa7_Qp.js').then(n => n.b);return { default: WS }},true              ?__vite__mapDeps([0,1]):void 0).then(({ default: WS }) => {
...
const Login = React.lazy(() => __federation_method_getRemote("loginApp" , "./Login").then(module=>__federation_method_wrapDefault(module, true)));
const TaskDashboard = React.lazy(() => __federation_method_getRemote("taskApp" , "./TaskDashboard").then(module=>__federation_method_wrapDefault(module, true)));
function App() {

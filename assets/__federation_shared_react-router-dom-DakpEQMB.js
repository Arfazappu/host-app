...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  ...
  let { navigator, static: isStatic } = React2$1.useContext(NavigationContext);
...
function useRevalidator() {
  ...
  let revalidate = React2$1.useCallback(async () => {
